...
/**
 * A proxy interface to support the sorting of colours in different colour
 * spaces. Used by {@link ColourList#sortByDistance(DistanceProxy, boolean)}.
 * 
 * @author toxi
 * 
 */
public interface DistanceProxy {
	/**
	 * Computes the distance between 2 colours.
	 * 
	 * @param a
	 * @param b
	 * @return distance
	 */
	float distanceBetween(Colour a, Colour b);
}
