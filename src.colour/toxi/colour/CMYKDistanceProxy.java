...
/**
 * Implements the {@link DistanceProxy} interface to sort colours by CMYK
 * distance (used by {@link ColourList#sortByDistance(DistanceProxy, boolean)}).
 * 
 * @author toxi
 * 
 */
public class CMYKDistanceProxy implements DistanceProxy {
	...
	public float distanceBetween(Colour a, Colour b) {
