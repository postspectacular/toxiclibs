...
/**
 * Compares 2 colours by one of their CMYK component values.
 * 
 * @author toxi
 * 
 */
public class CMYKComparator implements Comparator<Colour> {
	...
	public int compare(Colour a, Colour b) {
		return Float.compare(a.cmyk[component], b.cmyk[component]);
	}
