...
/**
 * Compares two colours by their distance to the given target colour.
 * 
 * @author toxi
 * 
 */
public class ProximityComparator implements Comparator<Colour> {

	protected Colour col;
	protected DistanceProxy proxy;

	public ProximityComparator(Colour col, DistanceProxy proxy) {
		this.col = col;
		this.proxy = proxy;
	}
