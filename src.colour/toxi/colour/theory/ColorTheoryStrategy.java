...
/**
 * A simple interface for implementing rules used to create colour palettes. The
 * library currently comes with 10 default implementations realising different
 * colour theory approaches.
 * 
 * @author toxi
 * 
 */
public interface ColorTheoryStrategy {
	...
	/**
	 * Creates a new {@link ColourList} of colours for the supplied source
	 * colour based on the strategy. The number of colours returned is
	 * unspecified and depends on the strategy.
	 * 
	 * @param src
	 *            source colour
	 * @return list of matching colours created by the strategy.
	 */
	ColourList createListFromColour(Colour src);
